...
class MS_Gateway_Nochex_View_Settings extends MS_View {
	...
	public function to_html() {
		...
		<form class="ms-gateway-settings-form ms-form">
			...
			$description = 'Pay securely with Credit / Debit Card (Nochex).';
	...
	protected function prepare_fields() {
		...
		$fields = array(
			...
			'merchant_id' 	=> array(
				...
				'title' 		=> __( 'Nochex Email Address / Merchant ID', 'membership2' ),
			...
			'mode' 			=> array(
				...
				'title' 		=> __( 'Nochex Mode', 'membership2' ),
			...
			'pay_button_url' => array(
				...
				'title' 		=> __( 'Payment button label or URL', 'membership2' ),
